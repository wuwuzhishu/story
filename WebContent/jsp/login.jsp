...
<form class="form-horizontal"  method="post" action="${pageContext.request.contextPath }/UserServlet">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text"   value="${cookie.u.value }" name="username" class="form-control" id="username" placeholder="请输入用户名">
    </div>
  </div>
   <div class="form-group">
  ...
  <span style="color:red">${msg }</span>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="remer"  <c:if test="${cookie.u.value != null }"> checked="checked" </c:if>  value="1"> 记住用户名
        </label>
      </div>
    </div>
  </div>
